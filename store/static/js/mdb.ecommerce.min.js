!(function (t) {
    ...
    function (t, n, e) {
        ...
        })("versions", []).push({ version: "3.3.2", mode: r ? "pure" : "global", copyright: "Â© 2019 Denis Pushkarev (zloirock.ru)" });
    },
    function (t, n) {
        t.exports = function (t) {
        ...
        o("inspectSource", function (t) {
            ...
            (t.exports = function (t, n, e, o) {
                var u = !!o && !!o.unsafe,
                    s = !!o && !!o.enumerable,
                    f = !!o && !!o.noTargetGet;
                "function" == typeof e && ("string" != typeof n || c(e, "name") || i(e, "name", n), (l(e).source = p.join("string" == typeof n ? n : ""))),
                    t !== r ? (u ? !f && t[n] && (s = !0) : delete t[n], s ? (t[n] = e) : i(t, n, e)) : s ? (t[n] = e) : a(n, e);
                    ...
                    (r =
                        "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length
                            ? function (t, e) {
                                  ...
                                  for (
                                      var a, u, s, f = [], p = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), d = 0, h = new RegExp(t.source, p + "g");
                                      (a = l.call(h, r)) && !((u = h.lastIndex) > d && (f.push(r.slice(d, a.index)), a.length > 1 && a.index < r.length && v.apply(f, a.slice(1)), (s = a[0].length), (d = u), f.length >= i));
            ...
            return (function i(c) {
                ...
                function l(t, e, r) {
                    if ("undefined" != typeof document) {
                        ...
                        (e = c.write ? c.write(e, t) : encodeURIComponent(String(e)).replace(/%(23|24|26|2B|3A|3C|3E|3D|2F|3F|40|5B|5D|5E|60|7B|7D|7C)/g, decodeURIComponent)),
                ...
                ($.fn.mdbEcommerceGallery = function () {
                    ...
                    t.on("mousemove", function (t) {
                        ...
                        $(this)
                            .find("img")
                            .first()
                            .css({ "transform-origin": "center center", transform: "scale(4.5) translate(".concat(r, "px, ").concat(o, "px)") });
                    }),
